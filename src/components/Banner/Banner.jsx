...
const Banner = () => {
    return (
        <div className='flex justify-between'>
            <div className="banner-description text-left w-2/3 my-6 space-y-7">
                ...
                <p className='w-3/5'>Explore thousands of job opportunities with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
